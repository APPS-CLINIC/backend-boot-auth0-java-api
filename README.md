...
2. go to Tenant Settings  in the top right next to avatar, / Advanced and change "Feature Previews" / "New Dashboard Experience" to enabled (green)
![New Dashboard Experience](images/1.png)
3. Follow the instruction here 
- https://auth0.com/docs/quickstart/backend (home for quickstarts)
- https://auth0.com/docs/quickstart/backend/java-spring-security5 (what we are interested in)
4. Once you are logged in and you have created your API, you can download this project pre-configured for your api :)
5. Have fun !
6. PS - you might want to set "debug: false" in application.yml
    ...
    oauth2:
      resourceserver:
        jwt:
          ...
          issuer-uri: https://dev-14u8nopa.eu.auth0.com/
```
